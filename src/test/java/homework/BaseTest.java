...
{
    // creating object to call browsersetup class here so can use multibrowser option
    ...
    public void openBrowser()
    {
        ...
        // i comment out next code because in firefox and IE its already giving full window when it open
